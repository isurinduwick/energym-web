        ...
        <div class="container">
            ...
            <div class="user-dropdown">
                ...
                <div class="dropdown-menu" id="dropdownMenu">
                    ...
                    <a href="<?php echo e(url('/fatburnmembernotifications')); ?>" style="display: flex; align-items: center;">Notifications</a>
    ...
    <div class="bodybuilder">
        ...
        <div class="center-section">
            <h1 class="moti">
                ...
                ?>
                <?php echo e($difference); ?>KG More to Lose <br>
                <span style="color: #c11325">YOU CAN DO IT!</span>
            </h1>

        </div>
        <h3 class="target">Target Weight: <?php echo e($targetWeight); ?>KG</h3>
    </div>
</section>
...
<?php /**PATH C:\Users\user\Downloads\laragym-master\final\energym-gymnasium\resources\views/member/fatburn-member.blade.php ENDPATH**/ ?>