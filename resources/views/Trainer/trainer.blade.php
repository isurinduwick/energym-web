...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/css/trainer.css')}}">
    @php
        ...
        <div class="container">
            ...
            <div class="user-dropdown">
                ...
                <div class="dropdown-menu" id="dropdownMenu">
                    <a href="{{ route('traineredit.profile') }}">Preferences</a>
                    <a href="{{ url('/trainernotifications') }}" style="display: flex; align-items: center;">Notifications</a>
        ...
        <div class="nav">
            ...
            <ul>
               <li> <a href="{{ route('trainer.view') }}">
                ...
                <li><a href="{{ route('upload.view') }}">
                   <img src="{{ asset('assets/images/Uploadtrainer.png') }}" style="width: 24px; height: 24px; margin-right: 8px;">
                    Upload</a></li>
...
<section>
    <div class="trainer">
      <a href="{{ route('traineredit.profile') }}"><button class="pref">Preferences</button></a>
      <a href="{{ route('upload.view') }}"><button class="schedule">Schedule Upload</button></a>
      <a href="{{ url('/trainerpaysheet') }}"><button class="paysheet">View Paysheets</button></a>
      <a href="{{ url('/trainernotifications') }}"><button class="notification">Notifications</button></a>
    </div>
</section>
