...
<body>
    <div class="container">
        ...
        <form method="POST" action="{{ route('trainerstore.profile') }}" enctype="multipart/form-data">
            @csrf
            ...
            <!-- Field for changing User name -->
            <div class="form-group">
                <label for="username">User Name:</label>
                <input type="text" id="username" name="username" value="{{ $editData->username }}" required>
            </div>
