...
<body>
 ...
 <header>
 	 <div class="container">
        ...
        <div class="reg-btn">
            <button><a href="{{ url('/login') }}">Log<span>In</span></button></a>
        </div>
  	  ...
  	  <div class="container">
  	  	  <div class="content">
  	  	  	   <div class="box wow bounceInUp">
  	  	  	   	   <div class="inner">
  	  	  	   	   	   <div class="img">
  	  	  	   	   	   	  <img src="{{asset('assets/images/about1.jpg')}}" alt="about" />
  	  	  	   	   	   </div>
                       <div class="text">
  	  	  	   	...
  	  	  	   	<div class="box wow bounceInUp" data-wow-delay="0.2s">
  	  	  	   	   <div class="inner">
  	  	  	   	   	   <div class="img">
  	  	  	   	   	   	  <img src="{{asset('assets/images/about2.jpg')}}" alt="about" />
  	  	  	   	   	   </div>
                       <div class="text">
                       	   <h4>Best Training</h4>
	...
	<div class="container">
		 <div class="content">
		 	  <div class="box img wow slideInLeft">
		 	  	 <img src="{{asset('assets/images/class2.png')}}" alt="classes" />
		 	  </div>
		 	  <div class="box text wow slideInRight">
		 	  	...
		 	  	<div class="class-items">
		 	  	 <div class="item wow bounceInUp">
                     <div class="item-img">
                     	 <img src="{{asset('assets/images/class1.jpg')}}" alt="classes" />
                     	 <div class="price">
 	...
 	<div class="container">
 		 <div class="content">
 		 	  <div class="box text wow slideInLeft">
 		 	  	 ...
 		 	  	 <a href="{{ url('/reg') }}" class="btn">Start Now</a>
 		 	  </div>
 		 	  <div class="box img wow slideInRight">
 		 	  	 <img src="{{asset('assets/images/gallery4.j')}}pg" alt="start today" />
 		 	  </div>
  	 ...
  	 <div class="container">
  	 	  <div class="content">
                    ...
                    Explore our diverse class schedule, crafted to suit all fitness levels and schedules. From morning yoga to evening spin, we've got something for everyone. Join us and elevate your workout routine today.
  	 	  	   	   ...
  	 	  	   	   <img src="{{asset('assets/images/schedule1.')}}png" alt="schedule" />
  	 	  	   </div>
  ...
  <section class="gallery" id="gallery">
  	...
  	<div class="content">
  		 <div class="box wow slideInLeft">
  		 	 <img src="{{asset('assets/images/gym photos/gym.pic1.jpg')}}" alt="gallery" />
  		 </div>
  		 <div class="box wow slideInRight">
  		 	 <img src="{{asset('assets/images/gym photos/IMG-20240425-WA0047.jpg')}}" alt="gallery" />
  		 </div>
  		 <div class="box wow slideInLeft">
  		 	 <img src="{{asset('assets/images/gym photos/gym.pic4.jpg')}}" alt="gallery" />
  		 </div>
  		 <div class="box wow slideInRight">
  		 	 <img src="{{asset('assets/images/gym photos/IMG-20240425-WA0058.jpg')}}" alt="gallery" />
  		 </div>
  	</div>
  </section>
<!-- End Gallery -->
  	 	  ...
  	 	  <div class="content">
  	 	  	  <div class="box wow bounceInUp">
  	 	  	  	  <div class="inner">
  	 	  	  	  	   ...
  	 	  	  	  	   <div class="img">
  	 	  	  	  	   	 <img src="{{asset('assets/images/price1.jpg')}}" alt="price" />
  	 	  	  	  	   </div>
  	 	  	  	  	   <div class="text">
  	 	  	  	  	   	  ...
  	 	  	  	  	   	  <p>Gym and Cardio</p>
  	 	  	  	  	   	  <p></p>
  	 	  	  	  	   	  <a href="{{ url('#contact') }}" class="btn">Join Now</a>
  	 	  	  	  	   </div>
  	 	  	  	  </div>
  	 	  	  </div>
  	 	  	  <div class="box wow bounceInUp" data-wow-delay="0.2s">
  	 	  	  	  <div class="inner">
  	 	  	  	  	   ...
  	 	  	  	  	   <div class="img">
  	 	  	  	  	   	 <img src="{{asset('assets/images/price2.jpg')}}" alt="price" />
  	 	  	  	  	   </div>
  	 	  	  	  	   <div class="text">
  	 	  	  	  	   	  <h3>Body Building Training</h3>
  	 	  	  	  	   	  <p>Get Free WiFi</p>
  	 	  	  ...
  	 	  	  <div class="box wow bounceInUp" data-wow-delay="0.4s">
  	 	  	  	  <div class="inner">
  	 	  	  	  	   ...
  	 	  	  	  	   <div class="img">
  	 	  	  	  	   	 <img src="{{asset('assets/images/price3.jpg')}}" alt="price" />
  	 	  	  	  	   </div>
  	 	  	  	  	   <div class="text">
  	 	  	  	  	   	  <h3>Body Building Training</h3>
  	 	  	  	  	   	  <p>Get Free WiFi</p>
