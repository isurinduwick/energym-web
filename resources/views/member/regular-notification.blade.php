...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark" style="background-color: black; position: fixed; top: 0; width: 100%;">
        <a href="{{ route('regular.member.view') }}"><img style="width: 40px" src="{{ asset('assets/images/Left.png') }}" alt="" srcset=""></a>
        <div class="container">
            ...
            <div class="mx-auto" m-lg-2 >
                <a class="navbar-brand" href="{{ url('/notifications') }}">Chat & Updates</a>
            </div>
        </div>
